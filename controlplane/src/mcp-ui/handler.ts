...
export const UI_TOOLS = [
  ...
  },
  {
    ...
    description: 'Create an integration block on the dashboard. The block handles OAuth connection via its built-in Connect button. Supported providers: gmail, calendar, contacts, sheets, forms, slack, discord, telegram, whatsapp, teams, matrix, google_chat, outlook, outlook_calendar',
    inputSchema: {
      type: 'object',
      properties: {
        dashboard_id: {
